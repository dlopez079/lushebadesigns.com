<section id="hero" class="relative bg-gray-50 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                    <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                        ...
                        <!-- Logo / Hamburger Menu -->
                        <div class="hidden flex items-center justify-between w-full md:w-auto">
                            <a href="#" class="hidden">
                    ...
                    <div class="hidden md:flex md:space-x-10">
                        <a href="#services" class="font-medium text-gray-500 hover:text-gray-900">Services</a>
        ...
        <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
            <div class="text-center">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">Lusheba Designs</span> <br>
                    <span class="block text-indigo-600 xl:inline">Nikolai Systems Designs</span>
                </h1>
                <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    Superior Specialist in Chimney Inspections, Exhaust System Inspections and Smoke tests to keep your
