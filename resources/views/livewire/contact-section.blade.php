    ...
    <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
        <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            <div class="max-w-lg mx-auto">
                ...
                <p class="mt-3 text-lg leading-6 text-gray-500">
                    Don't hesitate to contact us for your next inspection.
                </p>
                <dl class="mt-8 text-base text-gray-500">
                    <div>
                        <dt class="sr-only">Postal address</dt>
                        <dd>
                            <p>Nikolai Design Systems Inc dba</p>
                            <p>Lusheba Designs</p>
                            <p>4228-38 Park Avenue </p>
                            <p>Bronx NY 10457</p>
                        </dd>
                    </div>
                    <div class="mt-6">
                    ...
                    <div class="mt-3">
                        ...
                        <dd class="flex">
                            ...
                            <span class="ml-3">
                                info@lushebadesigns.com
                            </span>
                        </dd>
                    </div>
                </dl>
                <p class="hidden mt-6 text-base text-gray-500">
                    Looking for careers?
        ...
        <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
            ...
            <div class="max-w-lg mx-auto lg:max-w-none">
                ...
                <form wire:submit.prevent="submitForm" class="grid grid-cols-1 gap-y-6">

                    @csrf

                    <div>
                        <label for="full-name" class="sr-only">Full name</label>
                        <input wire:model.lazy="name" type="text" name="full-name" id="full-name" autocomplete="name"
                    ...
                    <div>
                        ...
                        <input wire:model.lazy="phone" type="text" name="phone" id="phone" autocomplete="tel"
                            class="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
                            placeholder="Phone">
                    </div>
                    @error('phone')
                    ...
                    <div>
                        ...
                        <textarea wire:model.lazy="transmission" id="transmission" name="transmission" rows="4"
                            ...
                            placeholder="Enter your inquiry here..."></textarea>
                    </div>
                    @error('message')
                        <p class="text-red-500 text-sm mb-6 mt-3">{{ $message }}</p>
                    @enderror
                    ...
                    @if (session()->has('message'))
                        <div class="grid grid-cols-6 gap-6">
                            <div class="text-green-500 text-sm mb-6 mt-3">
                                <p>{{ session('message') }}</p>
                            </div>
                        </div>
                    @endif
